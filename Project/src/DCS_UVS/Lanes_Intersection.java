...
public class Lanes_Intersection {
	public static void main(String[] args) {
		...
		DataString full_msg = new DataString();
		full_msg.Printable = true;
		full_msg.SetName("full_msg");
		full_msg.SetValue("Full");
		pn.ConstantPlaceList.add(full_msg);
		...
		DataTransfer p_op1 = new DataTransfer();
		p_op1.SetName("OP1");
		p_op1.Value = new TransferOperation("localhost", "1081", "in1");
		pn.PlaceList.add(p_op1);
		...
		DataTransfer p_op2 = new DataTransfer();
		p_op2.SetName("OP2");
		p_op2.Value = new TransferOperation("localhost", "1082", "in2");
		pn.PlaceList.add(p_op2);
		...
		DataTransfer p_op3 = new DataTransfer();
		p_op3.SetName("OP3");
		p_op3.Value = new TransferOperation("localhost", "1083", "in3");
		pn.PlaceList.add(p_op3);
		...
		DataTransfer p_op4 = new DataTransfer();
		p_op4.SetName("OP4");
		p_op4.Value = new TransferOperation("localhost", "1082", "in4");
		pn.PlaceList.add(p_op4);
		...
		t_o1.InputPlaceName.add("P_a1");
		t_o1.InputPlaceName.add("P_x1");
		t_o1.IsAsync = true;

		Condition T_o1Ct1 = new Condition(t_o1, "P_a1", TransitionCondition.NotNull);
		Condition T_o1Ct2 = new Condition(t_o1, "P_x1", TransitionCondition.CanNotAddCars);
		T_o1Ct2.SetNextCondition(LogicConnector.AND, T_o1Ct2);

		GuardMapping grdT_o1 = new GuardMapping();
		grdT_o1.condition = T_o1Ct1;
		grdT_o1.Activations.add(new Activation(t_o1, "full_msg", TransitionOperation.SendOverNetwork, "OP1"));
		...
		t_o2.InputPlaceName.add("P_a2");
		t_o2.InputPlaceName.add("P_x2");
		t_o2.IsAsync = true;

		Condition T_o2Ct1 = new Condition(t_o2, "P_a2", TransitionCondition.NotNull);
		Condition T_o2Ct2 = new Condition(t_o2, "P_x2", TransitionCondition.CanNotAddCars);
		T_o2Ct1.SetNextCondition(LogicConnector.AND, T_o2Ct2);

		GuardMapping grdT_o2 = new GuardMapping();
		grdT_o2.condition = T_o2Ct1;
		grdT_o2.Activations.add(new Activation(t_o2, "full_msg", TransitionOperation.SendOverNetwork, "OP2"));
		...
		t_o3.InputPlaceName.add("P_a3");
		t_o3.InputPlaceName.add("P_x3");
		t_o3.IsAsync = true;

		Condition T_o3Ct1 = new Condition(t_o3, "P_a3", TransitionCondition.NotNull);
		Condition T_o3Ct2 = new Condition(t_o3, "P_x3", TransitionCondition.CanNotAddCars);
		T_o3Ct1.SetNextCondition(LogicConnector.AND, T_o3Ct2);

		GuardMapping grdT_o3 = new GuardMapping();
		grdT_o3.condition = T_o3Ct1;
		grdT_o3.Activations.add(new Activation(t_o3, "full_msg", TransitionOperation.SendOverNetwork, "OP3"));
		...
		t_o4.InputPlaceName.add("P_a4");
		t_o4.InputPlaceName.add("P_x4");
		t_o4.IsAsync = true;

		Condition T_o4Ct1 = new Condition(t_o4, "P_a4", TransitionCondition.NotNull);
		Condition T_o4Ct2 = new Condition(t_o4, "P_x4", TransitionCondition.CanNotAddCars);
		T_o4Ct1.SetNextCondition(LogicConnector.AND, T_o4Ct2);

		GuardMapping grdT_o4 = new GuardMapping();
		grdT_o4.condition = T_o4Ct1;
		grdT_o4.Activations.add(new Activation(t_o4, "full_msg", TransitionOperation.SendOverNetwork, "OP4"));
