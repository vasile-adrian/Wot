...
public class FLRS2X2 {
	...
	FLRS reader = new FLRS(new FV(FZ.NL), new FV(FZ.NM), new FV(FZ.ZR), new FV(FZ.PM), new FV(FZ.PL), //1st inpt
	...
	// T1 ------------------------------------------------
			...
			grdT1.Activations.add(new Activation(t1, doubleChannelAdder, input, TransitionOperation.FLRS, twoOutput));
